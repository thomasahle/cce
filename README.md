...
This repository contains the code for the paper ["Clustering the Sketch: Dynamic Compression for Embedding Tables"](https://openreview.net/forum?id=C4rRqkXFyC).
